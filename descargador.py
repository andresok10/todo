...
if not os.path.exists(BASE_DIR + "/ffmpeg"):
    ...
    if platform.system().lower().startswith("linux"):
        ...
        with tarfile.open(
            archivo, "r:xz"
        ) as tar:  # tarfile.open(archivo, "r:xz").extractall(ffmpeg_dir, filter="data")
...
def descargax():
    ...
    extension = (
        "m4a" if download_type == "audio" else "webm"
    )  # ej: mp4, mkv, webm, avi, mp3...
